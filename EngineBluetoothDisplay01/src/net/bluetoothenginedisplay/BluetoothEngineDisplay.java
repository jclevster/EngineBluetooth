 ...
 * 
 * This file has been modified by Jonas Cleveland for the EngineDisplay project.
 */
 ...
 */
public class BluetoothEngineDisplay {
    // Debugging
    private static final String TAG = "BluetoothEngineDisplay";
     ...
     */
    public BluetoothEngineDisplay(Handler handler) {
    ...
    public void simpleWrite(byte[] out) {
        // Create temporary object
        ConnectedThread r;
        // Synchronize a copy of the ConnectedThread
        synchronized (this) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (BluetoothEngineDisplay.this) {
                mConnectThread = null;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void noPadWrite(byte[] buffer) {
            try {
                ...
                Log.d(TAG, "SERVICE writer CHEESE: " + buffer);
